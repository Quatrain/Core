...
> 📦 **API Reference**: Detailed TypeScript documentation, classes, interfaces, and methods are available in the [TypeDoc API Reference for @quatrain/log ↗](/core/api-reference/modules/_quatrain_log.html).

...
> 📦 **API Reference**: Detailed TypeScript documentation, classes, interfaces, and methods are available in the [TypeDoc API Reference for @quatrain/storage-s3 ↗](/core/api-reference/modules/_quatrain_storage-s3.html).

...
> 📦 **API Reference**: Detailed TypeScript documentation, classes, interfaces, and methods are available in the [TypeDoc API Reference for @quatrain/storage-supabase ↗](/core/api-reference/modules/_quatrain_storage-supabase.html).

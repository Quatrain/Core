...
// Generate plain text
const answer = await deepseek.generateText('Explain regenerative viticulture in 2 paragraphs.');

// Generate structured data
const data = await deepseek.generateStructured(
  'Extract keywords from this article',
  { type: 'object', properties: { keywords: { type: 'array', items: { type: 'string' } } } }
);

// Stream text chunks
for await (const chunk of await deepseek.generateTextStream('Tell a story about wine.')) {
